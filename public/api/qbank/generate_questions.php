<?php
// Path: public/api/qbank/generate_questions.php
...
// Execute M1 controller handler for AI question generation
handle_generate_questions_request($requestData, $conn);
